...
static int int_add(lua_State* L) { return push_integer(L, check_integer(L, 1) + check_integer(L, 2)); }
static int int_sub(lua_State* L) { return push_integer(L, check_integer(L, 1) - check_integer(L, 2)); }
static int int_mul(lua_State* L) { return push_integer(L, check_integer(L, 1) * check_integer(L, 2)); }
static int int_div(lua_State* L) {
    LuaLibInteger denom = check_integer(L, 2);
    if (denom != 0) {
        return push_integer(L, check_integer(L, 1) / denom);
    }
...
static int int_band(lua_State* L) { return push_integer(L, check_integer(L, 1) & check_integer(L, 2)); }
static int int_bor(lua_State* L) { return push_integer(L, check_integer(L, 1) | check_integer(L, 2)); }
static int int_bxor(lua_State* L) { return push_integer(L, check_integer(L, 1) ^ check_integer(L, 2)); }
static int int_bnot(lua_State* L) { return push_integer(L, ~check_integer(L, 1)); }
static int int_shl(lua_State* L) { return push_integer(L, check_integer(L, 1) << check_integer(L, 2)); }
static int int_shr(lua_State* L) { return push_integer(L, check_integer(L, 1) >> check_integer(L, 2)); }
static int int_pow(lua_State* L) { return push_integer(L, (LuaLibInteger)(pow((lua_Number)check_integer(L, 1), (lua_Number)check_integer(L, 2)) + 0.5)); }
static int int_unm(lua_State* L) { return push_integer(L, -check_integer(L, 1)); }
static int int_eq(lua_State* L) {
    lua_pushboolean(L, check_integer(L, 1) == check_integer(L, 2));
    return 1;
}
...
static int int_tostring(lua_State* L) {
    lua_pushinteger(L, (lua_Integer)check_integer(L, 1));
    lua_tostring(L, -1);
    return 1;
}
...
static int int_abs(lua_State* L) { return push_integer(L, abs(check_integer(L, 1))); }
static int int_sqrt(lua_State* L) { return push_integer(L, (LuaLibInteger)sqrt((lua_Number)check_integer(L, 1))); }
static int int_min(lua_State* L) {
    int n = lua_gettop(L); /* number of arguments */
    LuaLibInteger dmin = check_integer(L, 1);
    int i;
    for (i = 2; i <= n; i++) {
        LuaLibInteger d = check_integer(L, i);
        if (d < dmin) {
            dmin = d;
        }
    }
...
static int int_max(lua_State* L) {
    int n = lua_gettop(L); /* number of arguments */
    LuaLibInteger dmax = check_integer(L, 1);
    int i;
    for (i = 2; i <= n; i++) {
        LuaLibInteger d = check_integer(L, i);
        if (d > dmax) {
